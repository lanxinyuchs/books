		...
		struct hdlc_header *hdlc, int len)
{
	...
	tracepoint(com_ericsson_hdlc, hdlc_data, buf);
}
...
void hdlc_trace_dbg(int line, const char *format, ...)
{
        ...
        tracepoint(com_ericsson_hdlc, hdlc_dbg, line, buffer);
}
...
void hdlc_trace_info(int line, const char *format, ...)
{
        ...
        tracepoint(com_ericsson_hdlc, hdlc_info, line, buffer);
}
...
void hdlc_trace_error(int line, const char *format, ...)
{
        ...
        tracepoint(com_ericsson_hdlc, hdlc_error, line, buffer);
}
