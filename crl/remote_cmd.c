...
/* ===================================================================== */
static int
pack_args_len(int argc, char **argv)
{
   int   i;
   int   count;
...
/* ===================================================================== */
static int
pack_args(int argc, char **argv, char *buf, int *size)
{
   int   i;
   char  *ptr;
   int   count;
...
/* ===================================================================== */
static char *
start_exec_cmd(union SIGNAL *sig, PROCESS cmd_pid)
{
...
/* ===================================================================== */
int
run_remote_command(int argc, char **argv)
{
   int           ret;
   union SIGNAL *sig;
   int           len;
...
/* ===================================================================== */
char *
next_remote_command(const char *expr, char *prev)
{
...
remote_command_help(char *name)
{
   ...
   sig = alloc(sizeof(struct coli_help_cmd_sig) + strlen(name), 
	       COLI_HELP_CMD);
...
/* ===================================================================== */
char *
remote_command_usage(char *name)
{
   ...
   sig = alloc(sizeof(struct coli_usage_cmd_sig) + strlen(name),
	       COLI_USAGE_CMD);
...
/* ===================================================================== */
char *
remote_command_descr(char *name)
{
   ...
   sig = alloc(sizeof(struct coli_descr_cmd_sig) + strlen(name),
	       COLI_DESCR_CMD);
