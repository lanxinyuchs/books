 ...
 *   Change  : Change from syslog to DBG printout when kill indication
 *             for a trace item can be found in linked list. This might
 *             happen when the same thread in a process is repetitivly
...
handleItemKilledInd(union itc_msg *msg)
{
   ...
   {
      DBG("TRI server received kill indication from "
