...
#define ECM_GET_MSGNO_FROM_MAIN(hdr)       *(uint32_t *)((uint32_t *)hdr + 5)
#define ECM_GET_MSGNO_FROM_ACK(hdr)        *(uint32_t *)((uint32_t *)hdr + 4)
#define ECM_GET_MSGNO_FROM_DATA(hdr)       *(uint32_t *)((uint32_t *)hdr + 3)

#define ECM_GET_ACK_NEXT_FROM_MAIN(hdr)    ECM_ACK_GET_NEXT((uint32_t *)hdr + 1)
#define ECM_GET_ACK_NEXT_FROM_ACK(hdr)     ECM_ACK_GET_NEXT((uint32_t *)hdr)
#define ECM_GET_ACK_NEXT_FROM_DATA(hdr)    ECM_ACK_GET_NEXT((uint32_t *)hdr - 1)
