...
struct a4ci_linkStatCfmS {
	...
	uint32_t			nrOfErrCtrlFields;
	uint32_t			nrOfErrAddFields;
...
extern struct a4ci_linkStatCfmS *g_stat;

#define INC_STAT(cntr, value)  	\
		__sync_add_and_fetch((uint32_t*)&g_stat->cntr, (uint32_t)value);
