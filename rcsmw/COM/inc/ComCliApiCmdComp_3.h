#ifndef COM_CLI_API_COMMAND_COMPONENT_3_H
#define COM_CLI_API_COMMAND_COMPONENT_3_H

#include "ComCliApiCmdComp_2.h"
 ...
 */
#ifdef __cplusplus
const ComMgmtSpiInterface_1T ComCliApiCmdCompIf_3Id = {"Put your component name here", "ComCliApiCommandComponent", "3"};
#endif
#ifndef __cplusplus
#define ComCliApiCmdCompIf_3Id (ComMgmtSpiInterface_1T){"Put your component name here", "ComCliApiCommandComponent", "3"}
#endif


/**
 * Auto complete sort order values
 */
typedef enum {
    ComCliSortOrderFirst = 0,
    ComCliSortOrderOption = 1,
    ComCliSortOrderAttribute = 2,
    ComCliSortOrderAction = 3,
    ComCliSortOderStruct = 4,
    ComCliSortOrderMO = 5,
    ComCliSortOrderCommand = 6,
    ComCliSortOrderLast = 7
} ComCliSortOrderEnum_3T;
...
struct ComCliApiContext_3T {
    ...
    ComReturnT (*setAutocompleteResult)(struct ComCliApiContext_3T *context,
                                        uint32_t lineNumber,
                                        uint32_t totalLineCount,
                                        uint32_t actionId,
    ...
    * */
    ...
    ComReturnT (*sessionShutdown)(struct ComCliApiContext_3T *context,
                                  uint32_t code);
    ...
    ComReturnT (*setSortableAutocompleteResult)(struct ComCliApiContext_3T *context,
            uint32_t lineNumber,
            uint32_t totalLineCount,
            uint32_t actionId,
            ComCliCompletionToken_1T type,
