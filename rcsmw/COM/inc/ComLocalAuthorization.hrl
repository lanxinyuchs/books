...
-hrl_id({"ComLocalAuthorization","11.4.0","/main/R2A/R3A/R5A/R6A/R9A/R11A/1"}).
...
-define(rule_types,
        [{ruleId, string},
         {ruleName, string},
         {permission, 'ComLocalAuthorization.PermissionType'},
         {ruleData, 'ComLocalAuthorization.RuleDataType'},
         {userLabel, string}]).
...
-define(localAuthorizationMethod_types,
        [{localAuthorizationMethodId, string},
         {administrativeState, 'ComLocalAuthorization.BasicAdmState'},
         {userLabel, string}]).
