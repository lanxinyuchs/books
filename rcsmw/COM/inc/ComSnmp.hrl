...
-hrl_id({"ComSnmp","10.12.0","/main/R2A/R3A/R4A/R5A/R6A/R9A/R11A/1"}).
...
-define(snmp_types,
        [{snmpId, string},
         {operationalState, 'ComSnmp.OperState'},
         {administrativeState, 'ComSnmp.BasicAdmState'},
...
-define(snmpTargetV1_types,
        [{snmpTargetV1Id, string},
         {community, 'ComSnmp.SnmpCommunity'},
         {administrativeState, 'ComSnmp.BasicAdmState'},
         {address, 'ComSnmp.IPAddress'},
         {port, 'ComSnmp.ComSnmp_SnmpTargetV1_port'},
         {isMibWritable, boolean},
         {operationalState, 'ComSnmp.OperState'},
         {networkPrefixLength, 'ComSnmp.ComSnmp_SnmpTargetV1_networkPrefixLength'}]).
...
-define(snmpTargetV2C_types,
        [{snmpTargetV2CId, string},
         ...
         {address, 'ComSnmp.IPAddress'},
         {port, 'ComSnmp.ComSnmp_SnmpTargetV2C_port'},
         {informTimeout, 'ComSnmp.Timeout'},
         {transportMethod, 'ComSnmp.NotifyType'},
         {isMibWritable, boolean},
         {operationalState, 'ComSnmp.OperState'},
         {administrativeState, 'ComSnmp.BasicAdmState'},
         {networkPrefixLength, 'ComSnmp.ComSnmp_SnmpTargetV2C_networkPrefixLength'}]).
...
-define(snmpTargetV3_types,
        [{snmpTargetV3Id, string},
         {user, 'ComSnmp.SnmpSecurityName'},
         {authProtocol, 'ComSnmp.AuthProtocol'},
         {privProtocol, 'ComSnmp.PrivProtocol'},
         {informRetryCount, uint32},
         {administrativeState, 'ComSnmp.BasicAdmState'},
         {address, 'ComSnmp.IPAddress'},
         {port, 'ComSnmp.ComSnmp_SnmpTargetV3_port'},
         {informTimeout, 'ComSnmp.Timeout'},
         {transportMethod, 'ComSnmp.NotifyType'},
         {snmpSecurityLevel, 'ComSnmp.SecurityLevel'},
...
-define(snmpViewV1_types,
        [{snmpViewV1Id, string},
         ...
         {readOids, {sequence,'ComSnmp.SnmpOid'}},
         {writeOids, {sequence,'ComSnmp.SnmpOid'}}]).
...
-define(snmpTargetV3Dtls_types,
        [{snmpTargetV3DtlsId, string},
         ...
         {administrativeState, 'ComSnmp.BasicAdmState'},
         {address, 'ComSnmp.IPAddress'},
         {port, 'ComSnmp.ComSnmp_SnmpTargetV3Dtls_port'},
         {informTimeout, 'ComSnmp.Timeout'},
         {transportMethod, 'ComSnmp.NotifyType'},
         {isMibWritable, boolean},
         {operationalState, 'ComSnmp.OperState'},
...
-define('HostAndPort_types',
        [{host, 'ComSnmp.IPAddress'},
         {port, 'ComSnmp.ComSnmp_HostAndPort_port'}]).
