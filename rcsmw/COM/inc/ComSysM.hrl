...
-hrl_id({"ComSysM","3.2.1002","/main/R2A/R3A/R4A/R5A/1"}).
...
-define(ntpServer_types,
        [{ntpServerId, string},
         {userLabel, string},
         {serverAddress, 'ComSysM.IpDNSAddress'},
         {administrativeState, 'ComSysM.BasicAdmState'}]).
...
-define(oamAccessPoint_types,
        [{oamAccessPointId, string},
         {accessPoint, moRef},
         {dscp, 'ComSysM.ComSysM_OamAccessPoint_dscp'},
         {ipv4address, moRef},
         {netconfPort, uint16},
         {sshPort, uint16}]).
...
-define(oamTrafficClass_types,
        [{oamTrafficClassId, string},
         {name, string},
         {dscp, 'ComSysM.ComSysM_OamTrafficClass_dscp'}]).
