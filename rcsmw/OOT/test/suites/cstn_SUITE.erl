%%% #0.    BASIC INFORMATION
%%% ----------------------------------------------------------
%%% %CCaseFile:	cstn_SUITE.erl %
%%% @author eolaand
%%% @copyright Ericsson AB 2017
%%% @version /main/R10A/R11A/4
%%%
...
%%% ----------------------------------------------------------
%%% Rev        Date       Name        What
%%% R10A/1     2017-05-02 etxpeno     Created
%%% R10A/6     2017-06-01 uabhten     Updated with TCs
%%% R10A/7     2017-06-08 uabhten     Removed unused variables
%%% R10A/10    2017-06-15 etxpeno     Fix when testing on target
%%% ----------------------------------------------------------
