...
cd $TOP && rm -f tgt_arm-wr6 && ln -s $PREFIX/lib/erlang tgt_arm-wr6
cd $TOP/../test/OTP && rm -f tgt_arm-wr6 && ln -s $PREFIX_TEST/lib/erlang tgt_arm-wr6
cd $TOP/../test/OTP/tgt_arm-wr6/lib && ln -s safe* safe
cd $TOP/tgt_arm-wr6 && ./Install -cross -sasl .
cd $TOP && cp -f src/erl tgt_arm-wr6/bin/erl
cd $TOP && cp -f src/erl tgt_arm-wr6/erts-*/bin/erl
