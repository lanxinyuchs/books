...
%%% #0.    BASIC INFORMATION
%%% ----------------------------------------------------------
%%% %CCaseFile:	pms2_rop_susp_1_pmi2_SUITE.erl %
...
-module(pms2_rop_susp_1_pmi2_SUITE).
...
-export([tc_1job_missing_value/1]).
...
%%========================================================================
%% tc_1job_missing_value(_Config) -> ok
%% 
%% @doc
%% Start one job with two counters. 
%% Send pmiData with only one counter value present.
%% Check that the ROP file is generated with suspect marking.
%% @end
%%========================================================================
tc_1job_missing_value(_Config) -> 
    %%-------------------------------------------------------------
    %% Definitions
    %%-------------------------------------------------------------
    App = ?NACKA,
    Job1 = "tc_1job_missing_value",
    GP  = ?GP_10_SEC,
    ...
    %% Check 1st ROP
    %%-------------------------------------------------------------
    ok = check_rop_file(1, ["<r p=\"2\">3443</r>", "suspect"], []),
