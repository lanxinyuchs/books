...
%%% #0.    BASIC INFORMATION
%%% ----------------------------------------------------------
%%% %CCaseFile:	pms_rop_ext_2_SUITE.erl %
...
all() -> 
    [
     ...
     tc_3job_1grp_each
     %% tc_1job_1app_2inst_lu_inc_multi, fails with badarg line 111 (stop app) 
    ].
