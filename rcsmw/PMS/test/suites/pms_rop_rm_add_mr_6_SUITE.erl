...
%%% #0.    BASIC INFORMATION
%%% ----------------------------------------------------------
%%% %CCaseFile:	pms_rop_rm_add_mr_6_SUITE.erl %
...
-module(pms_rop_rm_add_mr_6_SUITE).
...
add_rm_mr_in_cp(_Config) ->
    ...
    %%-------------------------------------------------------------
    %% Add and remove MR in the job in cp
    %%-------------------------------------------------------------
