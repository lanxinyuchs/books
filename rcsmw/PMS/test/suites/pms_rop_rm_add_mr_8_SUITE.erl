...
%%% #0.    BASIC INFORMATION
%%% ----------------------------------------------------------
%%% %CCaseFile:	pms_rop_rm_add_mr_8_SUITE.erl %
...
-module(pms_rop_rm_add_mr_8_SUITE).
...
%%========================================================================
%% rm_mr_after_cp(Config) -> ok.
%% 
%% @doc 
%% Creates one job with two mrs 
%% and removes one mr after collection period
%% @end
%%========================================================================
rm_mr_after_cp(_Config) ->
    %%-------------------------------------------------------------
    %% Definitions
    %%-------------------------------------------------------------
    App      = ?SUNE,
    ...
    ok = wait_pmi_report_rop(Values2 ++ [{LDN, []}], AppData),
