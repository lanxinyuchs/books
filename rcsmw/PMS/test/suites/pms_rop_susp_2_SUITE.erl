...
%%% #0.    BASIC INFORMATION
%%% ----------------------------------------------------------
%%% %CCaseFile:	pms_rop_susp_2_SUITE.erl %
...
-export([tc_1job_1app_pdf_too_long_susp/1,
	 ...
	 tc_1job_1app_2inst_sum_inc_multi_susp/1
	]).
...
all() -> 
    [
     ...
     tc_1job_1app_2inst_sum_inc_multi_susp
    ].
...
%% @end
tc_1job_1app_2inst_sum_inc_multi_susp(_Config) -> 
    {ok, _} = pms_erl_app:start(?NACKA, ?LDN1, 
