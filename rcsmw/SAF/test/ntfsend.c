		      ...
		      SaUint16T lengthAdditionalText)
{
  ...
  *notificationHeader->notifyingObject = notificationParams->notifyingObject;
  ...
  strncpy(notificationHeader->additionalText,
...
static void
fillInDefaultValues(saNotificationAllocationParamsT *notificationAllocationParams,
		 ...
		 const saNotificationFlagsT *notificationFlags)
{
  ...
  case SA_NTF_TYPE_ALARM:
    printf("Send Alarm Notification!\n");
    ...
    do {
      /* Allocate */
      errorCode =
	saNtfAlarmNotificationAllocate(ntfHandle,
				       ...
				       notificationAllocationParams->numProposedRepairActions,
				       /* use default allocation size */
				       notificationAllocationParams->variableDataSize);
      if (SA_AIS_OK != errorCode && SA_AIS_ERR_TRY_AGAIN != errorCode) {
	printf("saNtfAlarmNotificationAllocate %s\n", error_output(errorCode));
	return errorCode;
  ...
  case SA_NTF_TYPE_STATE_CHANGE:
    printf("Send State Change Notification!\n");
    ...
    do {
      /* Allocate */
      errorCode =
	saNtfStateChangeNotificationAllocate(ntfHandle,     /* handle to Notification Service instance */
					     ...
					     notificationAllocationParams->variableDataSize);
      if (SA_AIS_OK != errorCode && SA_AIS_ERR_TRY_AGAIN != errorCode) {
	printf("saNtfStateChangeNotificationAllocate %s\n",
	       error_output(errorCode));
	return errorCode;
      } else if (SA_AIS_OK == errorCode) {
  ...
  case SA_NTF_TYPE_OBJECT_CREATE_DELETE:
    printf("Send Object Create/Delete Notification!\n");
    if (*notificationFlags == (saNotificationFlagsT)DEFAULT_FLAG)
      {
	notificationParams->eventType =
    ...
    do {
      errorCode =
	saNtfObjectCreateDeleteNotificationAllocate(ntfHandle,      /* handle to Notification Service instance */
						    ...
						    notificationAllocationParams->variableDataSize);
      if (SA_AIS_OK != errorCode && SA_AIS_ERR_TRY_AGAIN != errorCode) {
	printf("saNtfObjectCreateDeleteNotificationAllocate %s\n",
	       error_output(errorCode));
	return errorCode;
      } else if (SA_AIS_OK == errorCode) {
  ...
  case SA_NTF_TYPE_ATTRIBUTE_CHANGE:
    printf("Send Attribute Change Notification!\n");
    if (*notificationFlags == (saNotificationFlagsT)DEFAULT_FLAG)
      {
	notificationParams->eventType =
    ...
    do {
      errorCode =
	saNtfAttributeChangeNotificationAllocate(ntfHandle, /* handle to Notification Service instance */
						 ...
						 notificationAllocationParams->variableDataSize);
      if (SA_AIS_OK != errorCode && SA_AIS_ERR_TRY_AGAIN != errorCode) {
	printf("saNtfAttributeChangeNotificationAllocate %s\n",
	       error_output(errorCode));
	return errorCode;
      } else if (SA_AIS_OK == errorCode) {
	...
	*(myAttributeChangeNotification.sourceIndicator) =
	...
	for (i = 0; i < notificationAllocationParams->numAttributes; i++) {
	  ...
	  if (notificationParams->changedAttributes[i].oldAttributePresent) {
	    myAttributeChangeNotification.changedAttributes[i].oldAttributeValue.int32Val =
	      notificationParams->changedAttributes[i].oldAttributeValue.int32Val;
	  }

	  myAttributeChangeNotification.changedAttributes[i].newAttributeValue.int32Val = notificationParams->changedAttributes[i].newAttributeValue.int32Val;
	}
      }
      if (SA_AIS_ERR_TRY_AGAIN == errorCode) {
	usleep(100000);
  ...
  case SA_NTF_TYPE_SECURITY_ALARM:
    printf("Send Security Alarm Notification!\n");
    if (*notificationFlags == (saNotificationFlagsT)DEFAULT_FLAG)
      {
    ...
    do {
      ...
      errorCode =
	saNtfSecurityAlarmNotificationAllocate(ntfHandle,   /* handle to Notification Service instance */
					       ...
					       notificationAllocationParams->variableDataSize);
      if (SA_AIS_OK != errorCode && SA_AIS_ERR_TRY_AGAIN != errorCode) {
	printf("saNtfSecurityAlarmNotificationAllocate %s\n",
	       error_output(errorCode));
	return errorCode;
      } else if (SA_AIS_OK == errorCode) {
 ...
 repeatedSend:
  ...
  case SA_NTF_TYPE_ALARM:
    ...
    do {
      ...
      if (SA_AIS_OK != errorCode && SA_AIS_ERR_TRY_AGAIN !=
	  errorCode) {
	printf("saNtfNotificationSend %s\n", error_output(errorCode));
	return errorCode;
      }
      if (SA_AIS_ERR_TRY_AGAIN == errorCode) {
	usleep(100000);
    ...
    do {
      ...
      if (SA_AIS_OK != errorCode && SA_AIS_ERR_TRY_AGAIN !=
	  errorCode) {
	printf("saNtfNotificationFree %s\n", error_output(errorCode));
	return errorCode;
      }
      if (SA_AIS_ERR_TRY_AGAIN == errorCode) {
	usleep(100000);
  ...
  case SA_NTF_TYPE_STATE_CHANGE:
    ...
    do {
      errorCode =
	saNtfNotificationSend(myStateChangeNotification.notificationHandle);
      if (SA_AIS_OK != errorCode && SA_AIS_ERR_TRY_AGAIN !=
	  errorCode) {
	printf("saNtfNotificationSend %s\n", error_output(errorCode));
	return errorCode;
    ...
    do {
      errorCode =
	saNtfNotificationFree(myStateChangeNotification.notificationHandle);
      if (SA_AIS_OK != errorCode && SA_AIS_ERR_TRY_AGAIN != errorCode) {
	printf("saNtfNotificationFree %s\n", error_output(errorCode));
	return errorCode;
      }
  ...
  case SA_NTF_TYPE_OBJECT_CREATE_DELETE:
    ...
    do {
      ...
      errorCode =
	saNtfNotificationSend(myObjectCreateDeleteNotification.notificationHandle);
      if (SA_AIS_OK != errorCode && SA_AIS_ERR_TRY_AGAIN !=
	  errorCode) {
	printf("saNtfNotificationSend %s\n", error_output(errorCode));
	return errorCode;
    ...
    do {
      ...
      errorCode =
	saNtfNotificationFree(myObjectCreateDeleteNotification.notificationHandle);
      if (SA_AIS_OK != errorCode && SA_AIS_ERR_TRY_AGAIN != errorCode) {
	printf("saNtfNotificationFree %s\n", error_output(errorCode));
	return errorCode;
      }
  ...
  case SA_NTF_TYPE_ATTRIBUTE_CHANGE:
    ...
    do {
      errorCode =
	saNtfNotificationSend(myAttributeChangeNotification.notificationHandle);
      if (SA_AIS_OK != errorCode && SA_AIS_ERR_TRY_AGAIN != errorCode) {
    ...
    do {
      ...
      errorCode =
	saNtfNotificationFree(myAttributeChangeNotification.notificationHandle);
      if (SA_AIS_OK != errorCode && SA_AIS_ERR_TRY_AGAIN !=
	  errorCode) {
  ...
  case SA_NTF_TYPE_SECURITY_ALARM:
    ...
    do {
      errorCode =
	saNtfNotificationSend(mySecurityAlarmNotification.notificationHandle);
      if (SA_AIS_OK != errorCode && SA_AIS_ERR_TRY_AGAIN != errorCode) {
	(void)printf("saNtfNotificationSend %s\n", error_output(errorCode));
	return errorCode;
      }
    ...
    do {
      errorCode =
	saNtfNotificationFree(mySecurityAlarmNotification.notificationHandle);
      if (SA_AIS_OK != errorCode && SA_AIS_ERR_TRY_AGAIN != errorCode) {
	(void)printf("saNtfNotificationFree %s\n", error_output(errorCode));
	return errorCode;
      }
...
int main(int argc, char *argv[])
{
  ...
  if (argc >= 1) {
    /* Check options */
    while ((current_option = getopt_long(argc, argv, "a:c:e:E:N:n:p:r:s:b:T:",
					 long_options, NULL)) != -1) {
      optionFlag = SA_TRUE;
	...
	myNotificationParams.additionalText =
	  malloc(myNotificationAllocationParams.lengthAdditionalText);
