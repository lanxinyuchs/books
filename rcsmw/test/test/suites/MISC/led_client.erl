%%% #0.    BASIC INFORMATION
%%% ----------------------------------------------------------
%%% %CCaseFile:	led_client.erl %
%%% @author etxivri
%%% @copyright Ericsson AB 2014
%%% @doc Server running on the SUT
%%%
%%% @end
%%%-------------------------------------------------------------------
...
set_led_behavior(Client, List)->
gen_server:call(Client, {apply, set_led_behavior, List}).
