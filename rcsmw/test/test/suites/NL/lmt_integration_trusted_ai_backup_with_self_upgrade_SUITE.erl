%%% #0.    BASIC INFORMATION
%%% ----------------------------------------------------------
%%% %CCaseFile:	lmt_integration_trusted_ai_backup_with_self_upgrade_SUITE.erl %
%%% @author etxmlar
...
-module(lmt_integration_trusted_ai_backup_with_self_upgrade_SUITE).
-author('etxmlar').
-vsn('/main/R9A/6').
-date('2017-06-21').
...
%%% Rev        Date       Name        What
%%% -----      ---------  --------    ------------------------
%%% R9A/1     2017-02-06  etxmlar     Created
%%% R9A/2     2017-02-06  etxmlar     Updated and checked in
%%% R9A/3     2017-02-06  etxmlar     Updated 
%%% R9A/4     2017-03-07  etxmlar     Changed timeout to total_timeout
%%% R9A/5     2017-04-02  etxderb     X3 UP: Downgrade to NL supp bootsig AXM5600
%%% R9A/6     2017-06-21  etxmlar     X3 UP: Downgrade to NL support for ee on secure locked hw
%%% ----------------------------------------------------------
%%%
...
-define(TCU_UP_WITH_NL_VERSION_R7Y03, "https://arm010-eiffel001.seki.rnd.ericsson.se:8443/nexus/content/repositories/public/com/ericsson/CXP9024419_5/R11Y/CXP9024419_5-R11Y.zip"). %%NL version CNX9012629-R7Y03
-define(DUS_UP_WITH_NL_VERSION_R5BX03, "https://arm010-eiffel001.seki.rnd.ericsson.se:8443/nexus/content/repositories/public/com/ericsson/CXP9024418_4/R19DV/CXP9024418_4-R19DV.zip").  %%NL version CNX9012629-R5BX03
...
lmt_integration_ai_load_backup_ipv4(Config) ->
    ct:log("TC: lmt_integration trusted ipv4 using backup and a NL self upgrade"),
    NodeName = proplists:get_value(nodename, Config),
	...
	BoardType when 	BoardType == "tcu04";				
			BoardType == "tcu0401" ->
	    download_config_in_tftpboot_dir(HW, ?TCU_UP_WITH_NL_VERSION_R7Y03);
	BoardType when 	BoardType == "dus5201";				
			BoardType == "dus3201" ->
	    download_config_in_tftpboot_dir(HW, ?DUS_UP_WITH_NL_VERSION_R5BX03);
