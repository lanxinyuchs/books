%%% #0.    BASIC INFORMATION
%%% ----------------------------------------------------------
%%% %CCaseFile:	lmt_integration_trusted_ipv4_SUITE.erl %
%%% @author etxmlar
...
-module(lmt_integration_trusted_ipv4_SUITE).
-author('etxmlar').
...
%%% R8A/4     2017-01-23  etxmlar     Removed code
...
init_per_testcase(TestCase, Config) 
  when TestCase == nodeUC640_A4_006;
       TestCase == nodeUC640_A4_002 ->
...
%%% @spec nodeUC640_A4_006(Config) -> ok
%%% @end
%%%--------------------------------------------------------------------
nodeUC640_A4_006(Config) ->
...
%%% @spec nodeUC640_A4_002(Config) -> ok
%%% @end
%%%--------------------------------------------------------------------
nodeUC640_A4_002(Config) ->
