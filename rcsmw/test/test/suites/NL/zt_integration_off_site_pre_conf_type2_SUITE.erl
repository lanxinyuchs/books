%%% #0.    BASIC INFORMATION
%%% ----------------------------------------------------------
%%% %CCaseFile:	zt_integration_off_site_pre_conf_type2_SUITE.erl %
%%% @author etxmlar
...
-module(zt_integration_off_site_pre_conf_type2_SUITE).
-author('etxmlar').
-vsn('/main/R9A/2').
-date('2017-02-10').
...
%%% Rev      Date        Name        What
%%% -----    ---------   --------    ------------------------
%%% R9A/1      2017-02-10  etxmlar     Created
%%% R9A/2      2017-02-10  etxmlar     Updated
%%% ----------------------------------------------------------
%%%
...
nodeUC640_N_002(Config) ->
    ...
    ct:pal("nodeUC640_N_002:~n" 
	   ...
	   "Board restore hard -> Download -> power off/on -> integrate.", []),
