...
## R2A/2      2014-02-18 etxivri     Added use of mod S1V2_imm_classes.xml, needed when new sw is used.
...
cp  /vobs/rcs/test/RCT_CRX901275/FAKE/FAKE_CNX9012695/FAKE_CAX1033161/test/upgrade/fault_test/a14_ugt_s1v2_cfg.xml $TMPDIR/tmpdir/squashfs-root/${FAKE_CXC}/${NAME}-${NEW_REV}/priv/ugt_s1v2_cfg.xml
