...
## Rev        Date       Name        What
## -----      -------    --------    ------------------------------------
## R2A/1      2014-02-28 etxivri     Created.
##                                   In ugt_s2_cfg.xml A18 is set to idicate which fault tha shall be 
##                                   used in the application ugt_s2
##                                   Use also mod_ugt_1_imm.xml to increase ver of s2.
##                                   Otherwise the new sw will not be used.
##                                   Added use of mod S2_imm_classes.xml, needed when new sw is used.
...
rm -f $TMPDIR/tmpdir/squashfs-root/${FAKE_CXC}/${NAME}-${NEW_REV}/priv/ugt_s2_cfg.xml
rm -f $TMPDIR/tmpdir/squashfs-root/${FAKE_CXC}/${NAME}-${NEW_REV}/priv/appdata/ugt_1_imm.xml
rm -f $TMPDIR/tmpdir/squashfs-root/${FAKE_CXC}/${NAME}-${NEW_REV}/priv/S2_imm_classes.xml
#rm -f $TMPDIR/tmpdir/squashfs-root/${FAKE_CXC}/${NAME}-${NEW_REV}/priv/S2instances_imm_objects.xml  NOT needed
#rm -f $TMPDIR/tmpdir/squashfs-root/${FAKE_CXC}/${NAME}-${NEW_REV}/priv/appdata/ugt_1_mim.xml   NOT needed

chmod 666 $TMPDIR/tmpdir/squashfs-root/${FAKE_CXC}/${NAME}-${NEW_REV}/priv/*.xml

cp  /vobs/rcs/test/RCT_CRX901275/FAKE/FAKE_CNX9012695/FAKE_CAX1033161/test/upgrade/fault_test/a18_ugt_s2_cfg.xml $TMPDIR/tmpdir/squashfs-root/${FAKE_CXC}/${NAME}-${NEW_REV}/priv/ugt_s2_cfg.xml

cp  /vobs/rcs/test/RCT_CRX901275/FAKE/FAKE_CNX9012695/FAKE_CAX1033161/test/upgrade/fault_test/a18_s2_mod_ugt_1_imm.xml $TMPDIR/tmpdir/squashfs-root/${FAKE_CXC}/${NAME}-${NEW_REV}/priv/appdata/ugt_1_imm.xml

cp  /vobs/rcs/test/RCT_CRX901275/FAKE/FAKE_CNX9012695/FAKE_CAX1033161/test/upgrade/imm_classes/S2_imm_classes.xml $TMPDIR/tmpdir/squashfs-root/${FAKE_CXC}/${NAME}-${NEW_REV}/priv/S2_imm_classes.xml
