...
## Rev        Date       Name        What
## -----      -------    --------    ------------------------------------
## R2A/1      2014-02-12 etxjovp     Created,
## R2A/2      2014-02-12 etxjovp     Remove last character from ugt_1_imm.xml,
##                                   to make metadata faulty.
...
sed '$s/.$//' $TMPDIR/tmpdir/squashfs-root/${FAKE_CXC}/${NAME}-${NEW_REV}/priv/appdata/ugt_1_imm.xml > tmp_ugt_1_imm.xml
rm -f $TMPDIR/tmpdir/squashfs-root/${FAKE_CXC}/${NAME}-${NEW_REV}/priv/appdata/ugt_1_imm.xml
mv tmp_ugt_1_imm.xml $TMPDIR/tmpdir/squashfs-root/${FAKE_CXC}/${NAME}-${NEW_REV}/priv/appdata/ugt_1_imm.xml 
