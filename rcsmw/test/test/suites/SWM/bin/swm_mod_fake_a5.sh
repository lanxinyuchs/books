...
## Rev        Date       Name        What
## -----      -------    --------    ------------------------------------
## R2A/1      2014-02-12 etxjovp     Created, To version not suported.
## R2A/3      2014-02-13 etxivri     update for all target types
...
cp  /vobs/rcs/test/RCT_CRX901275/FAKE/FAKE_CNX9012695/FAKE_CAX1033161/test/upgrade/fault_test/a5_mod_ugt_1_imm.xml $TMPDIR/tmpdir/squashfs-root/${FAKE_CXC}/${NAME}-${NEW_REV}/priv/appdata/ugt_1_imm.xml
