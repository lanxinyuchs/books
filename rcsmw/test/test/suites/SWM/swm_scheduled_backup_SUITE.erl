...
%%% see <a href="file://$RCT_TOP/test/lib/supp/esrc/rct_netconf.erl">rct_netconf.erl</a><br/>
%% @end
...
%%% R3A/1      2014-12-10 etxjotj     Change for configuration alarm
...
groups() ->
    [{schedule,[],[configure_backup_scheduler_single,
		   configure_backup_scheduler_periodic,
		   schedule_test_single,
		   schedule_test_single_unlocked,
		   schedule_test_periodic,
...
schedule_test_calendar(Config) ->
    ...
    TS = timestamp(),
    FutureTime = add_time(add_time(), TS),
    LegalTime = fn_time(FutureTime, extended_zonefree),
