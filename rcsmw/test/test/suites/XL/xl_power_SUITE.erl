...
%%% @version /main/R2A/R3A/R4A/R6A/R11A/R12A/1
...
%%% R12A/1     2017-11-30 etxivri     Increased timer when check rbsConfigLevel
%%% ----------------------------------------------------------
-export([suite/0,
	 init_per_suite/1,
	 end_per_suite/1,
...
cycle(_) ->
	...
	_ ->
		...
		{ok,Result} ->
		    ...
		    case wait_for_rbsConfigLevel(nc1, "anything", 300) of
			ok ->
			    ok;
