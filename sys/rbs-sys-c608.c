/*
 * RBS system C608 board specific initialization and data declaration
 *
...
static struct rbs_sys_bt_deps c608_bt = {
	.bt_ops = &rbs_sys_cpm_bt_ops,
	.bt_fn_depend = rbs_sys_fn_deps,
};

static int __init c608_bt_init(void)
{
	rbs_sys_add_bt_ops(&c608_bt, RBS_BT_C608);
	return 0;
}
postcore_initcall_sync(c608_bt_init);
