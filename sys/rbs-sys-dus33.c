...
static struct rbs_sys_bt_deps dus33_bt = {
	.bt_ops = &rbs_sys_cpm_bt_ops,
	.bt_fn_depend = rbs_sys_fn_deps,
};

static int __init dus33_bt_init(void)
{
	rbs_sys_add_bt_ops(&dus33_bt, RBS_BT_DUS33);
	return 0;
}
postcore_initcall_sync(dus33_bt_init);
