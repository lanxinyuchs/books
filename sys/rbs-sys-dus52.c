...
static struct rbs_sys_bt_deps dus52_bt = {
	.bt_ops = &rbs_sys_cpm_bt_ops,
	.bt_fn_depend = rbs_sys_fn_deps,
};

static int __init dus52_bt_init(void)
{
	rbs_sys_add_bt_ops(&dus52_bt, RBS_BT_DUS52);
	return 0;
}
postcore_initcall_sync(dus52_bt_init);
