/*
 * RBS system mDUSx3 board (BB6502 & BB6303)
 *
...
static struct rbs_sys_bt_deps mdusx3_bt = {
	.bt_ops = &rbs_sys_cpm_bt_ops,
	.bt_fn_depend = rbs_sys_fn_deps,
};

static int __init mdusx3_bt_init(void)
{
	rbs_sys_add_bt_ops(&mdusx3_bt, RBS_BT_MDUSX3);
	return 0;
}
postcore_initcall_sync(mdusx3_bt_init);
