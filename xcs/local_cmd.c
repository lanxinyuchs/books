 ...
 *   -----------------------
 *   Revised : 2013-04-26 K.M.Sridhar
 *   Change  : Added gpsh
...
{
	{ "exit", cmd_exit, EXIT_USAGE, EXIT_SHORT, EXIT_DESCR },
	{ "help", cmd_help, HELP_USAGE, HELP_SHORT, HELP_DESCR },
	{ "?",    cmd_help, HELP_USAGE, HELP_SHORT, HELP_DESCR }
};
 ...
 */
/* ===================================================================== */
char * next_local_command(const char *expr, const char *prev)
{
	int i;
 ...
 */
/* ===================================================================== */
int run_local_command(int argc, char **argv)
{
	int i;
 ...
 */
/* ===================================================================== */
char * local_command_help(char *name)
{
	int i;
 ...
 */
/* ===================================================================== */
char * local_command_usage(char *name)
{
	int i;
 ...
 */
/* ===================================================================== */
char * local_command_descr(char *name)
{
	int i;
