...
void usage()
{
	printf("Usage: mama-test -tc <test case nbr> [config dir] [test app dir]\n\n"
	       ...
	       "    21: Test setting rtsched\n"
	       "    22: Test resetting rtsched\n"
	       "    23: Test removing children\n"
	       "    24: Test setting child environment\n"
	       "    25: Test multiple mamacmd connections\n"
	       "    26: Test persistent id\n"
	       "\n"
...
int main(int argc, char *argv[])
{
	...
	switch (atoi(argv[2])) {
		...
		case 21:
			test = &test_rtsched;
			pfxn = rtsched_test_fxn;
			break;
		case 22:
			test = &test_rtsched_reset;
			pfxn = rtsched_reset_test_fxn;
			break;
		case 23:
			test = &test_terminate;
			pfxn = terminate_test_fxn;
			break;
		case 24:
			test = &test_env;
			pfxn = env_test_fxn;
		...
		case 25:
			...
			pfxn = multiple_connections_test_fxn;
			break;
		case 26:
			test = &test_persistent_id;
			pfxn = persistent_id_test_fxn;
			break;
		default:
