...
#define NODEID_CONN_ESTABLISH_REQ    (NODEID_MSG_BASE + 0x1)
#define NODEID_CONN_ESTABLISH_CFM    (NODEID_MSG_BASE + 0x2)
#define NODEID_CONN_ESTABLISH_REJ    (NODEID_MSG_BASE + 0x3)
#define NODEID_CONN_DISCONNECT_REQ   (NODEID_MSG_BASE + 0x4)
#define NODEID_CONN_DISCONNECT_CFM   (NODEID_MSG_BASE + 0x5)
#define NODEID_CONN_DISCONNECT_REJ   (NODEID_MSG_BASE + 0x6)
#define NODEID_CONN_MONITOR_FWD      (NODEID_MSG_BASE + 0x7)

#define NODE_ID_READ_REQ    (NODEID_MSG_BASE + 0x9)
#define NODE_ID_READ_CFM    (NODEID_MSG_BASE + 0xA)
#define NODE_ID_READ_REJ    (NODEID_MSG_BASE + 0xB)

#define NODE_ID_WRITE_REQ   (NODEID_MSG_BASE + 0xC)
#define NODE_ID_WRITE_CFM   (NODEID_MSG_BASE + 0xD)
#define NODE_ID_WRITE_REJ   (NODEID_MSG_BASE + 0xE)

#define NODE_ID_ERASE_REQ  (NODEID_MSG_BASE + 0xF)
#define NODE_ID_ERASE_CFM  (NODEID_MSG_BASE + 0x10)
#define NODE_ID_ERASE_REJ  (NODEID_MSG_BASE + 0x11)
