...
nvpi3_result_t nvpi3_fdt_get_db_size(void *header, uint32_t *size);

nvpi3_result_t nvpi3_fdt_create_db(void *address, uint32_t size,
...
nvpi3_result_t nvpi3_fdt_set_value(void *h_db, const char *key_name,
                                   nvpi3_key_type_t type, uint32_t size,
                                   const union nvpi3_key_value *value);

nvpi3_result_t nvpi3_fdt_delete_key(void *h_db, const char *key_name,
                                    nvpi3_key_type_t type);
