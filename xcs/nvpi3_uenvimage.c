...
nvpi3_result_t nvpi3_uenvimage_get_db_header_size(uint32_t *size)
{
	return nvpi3_flat_ascii_get_db_header_size(size);
}

nvpi3_result_t nvpi3_uenvimage_get_db_size(void *header, uint32_t *size)
{
	return nvpi3_flat_ascii_get_db_size(header, size);
}

nvpi3_result_t nvpi3_uenvimage_create_db(
	void *address, uint32_t size, int clear,
	__attribute__((__unused__)) uint32_t recursive_limit, void **h_db)
{
	/* CRC-32 occupies first 4 bytes, so address needs to be incremented. */
	return nvpi3_flat_ascii_create_db((char *) address + 4, size, clear,
	                                  '\0', h_db);
}

nvpi3_result_t nvpi3_uenvimage_resize_db(void *h_db, void *address,
                                        uint32_t size)
{
	return nvpi3_flat_ascii_resize_db(h_db, address, size);
}

nvpi3_result_t nvpi3_uenvimage_destroy_db(void *h_db)
{
	return nvpi3_flat_ascii_destroy_db(h_db);
}

nvpi3_result_t nvpi3_uenvimage_open_node(void *h_db, void *h_parent_node,
...
nvpi3_result_t nvpi3_uenvimage_close_node(void *h_node)
{
	return nvpi3_flat_ascii_close_node(h_node);
}

uint32_t nvpi3_uenvimage_get_node_path_size(void *h_node)
{
	return nvpi3_flat_ascii_get_node_path_size(h_node);
}

nvpi3_result_t nvpi3_uenvimage_get_node_path(void *h_node, char *path,
                                             uint32_t size)
{
	return nvpi3_flat_ascii_get_node_path(h_node, path, size);
}

nvpi3_result_t nvpi3_uenvimage_get_value(void *h_node, const char *key_name,
...
nvpi3_result_t nvpi3_uenvimage_get_value_size(void *h_node,
                                              const char *key_name,
                                              nvpi3_key_type_t type,
                                              uint32_t *size)
{
...
nvpi3_result_t nvpi3_uenvimage_add_node(void *h_node, const char *name,
                                        uint32_t length, void **h_subnode)
{
	return nvpi3_flat_ascii_add_node(h_node, name, length, h_subnode);
}

nvpi3_result_t nvpi3_uenvimage_delete_node(void *h_node)
{
	return nvpi3_flat_ascii_delete_node(h_node);
}

nvpi3_result_t nvpi3_uenvimage_set_value(void *h_db, const char *key_name,
...
nvpi3_result_t nvpi3_uenvimage_delete_key(void *h_db, const char *key_name,
                                          nvpi3_key_type_t type)
{
	return nvpi3_flat_ascii_delete_key(h_db, key_name, type);
}

nvpi3_result_t nvpi3_uenvimage_enum_nodes(
...
nvpi3_result_t nvpi3_uenvimage_enum_keys(
	void *h_node,
