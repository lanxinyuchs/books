...
extern struct test test_rtsched;
extern struct test test_rtsched_reset;
extern struct test test_terminate;
extern struct test test_env;
extern struct test test_connections;
extern struct test test_persistent_id;
...
extern int rtsched_test_fxn(char *test_dir);
extern int rtsched_reset_test_fxn(char *test_dir);
extern int terminate_test_fxn(char *test_dir);
extern int env_test_fxn(char *test_dir);
extern int multiple_connections_test_fxn(char *test_dir);
extern int persistent_id_test_fxn(char *test_dir);
