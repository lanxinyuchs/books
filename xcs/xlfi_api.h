 ...
 *                              returned.
 *
 * @return  @ref XLFI_RESULT_INVALID_PARAM     Invalid file info supplied or
 ...
 * @param[in] num_of_files  The number of elements in file array.
 * @param[in] file          Array of LM info.
 *                          Should be set to NULL if XLF only contains pl.
 ...
 *
 * @return  @ref XLFI_RESULT_INVALID_PARAM     Invalid file info supplied.
 *          @ref XLFI_RESULT_NOT_ENOUGH_SPACE  xlf_size is too small.
 */
